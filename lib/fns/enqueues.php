...
function enqueue_scripts(){
    ...
    wp_register_script( 'video-js', HPM_PLUGIN_DIR_URL . 'lib/js/video.min.js', ['jquery'], '7.3.0' );
    wp_enqueue_script( 'proposal', HPM_PLUGIN_DIR_URL . 'lib/js/proposal.js', ['jquery','js-cookie','video-js'], filemtime( HPM_PLUGIN_DIR_PATH . 'lib/js/proposal.js'), true );
